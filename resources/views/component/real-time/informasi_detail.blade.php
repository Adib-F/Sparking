...
<script>
    ...
    class VideoStream {
        ...
        init() {
            ...
            this.streamUrl = `https://superb-prophet-designing-advanced.trycloudflare.com/clean_video_feed?camera_id=${this.cameraId}&subzona_id=${this.subzonaId}`;
    ...
    async function loadSubzonaData(subzonaId) {
        try {
            ...
            if (typeof data.camera_id !== 'undefined' && data.camera_id !== null) {
